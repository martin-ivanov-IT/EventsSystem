        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friendships_AspNetUsers_FriendFromID",
                        column: x => x.FriendFromID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Friendships_AspNetUsers_FriendToID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntranceFee = table.Column<int>(nullable: true),
                    EntranceType = table.Column<int>(nullable: false),
                    PlaceId = table.Column<int>(nullable: false),
                    PlaceUrl = table.Column<string>(nullable: true),
                    InitiatorId = table.Column<int>(nullable: false),
                    InitiatorId1 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Events", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Events_AspNetUsers_InitiatorId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventReviews_Places_PlaceId",
                        column: x => x.PlaceId,
                        principalTable: "Places",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventReviews_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventVote_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventVote_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventReviews_PlaceId",
                table: "EventReviews",
                column: "PlaceId");

            migrationBuilder.CreateIndex(
                name: "IX_EventReviews_UserId1",
                table: "EventReviews",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_Events_InitiatorId1",
                table: "Events",
                column: "InitiatorId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventVote_UserId",
                table: "EventVote",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Friendships_FriendFromID",
                table: "Friendships",
                column: "FriendFromID");

            migrationBuilder.CreateIndex(
                name: "IX_Friendships_FriendToID",
                table: "Friendships",
                column: "FriendToID");
